// Differences to ripemd128:
// - 5 state vars instead of 4 (same with constants)
// - 80 rounds instead of 64
// - digest length 20 bytes (160 bits) up from 16 bytes (128 bits)
...
const k = [5]u32{ 0x00000000, 0x5a827999, 0x6ed9eba1, 0x8f1bbcdc, 0xa953fd4e };
const k_p = [5]u32{ 0x50a28be6, 0x5c4dd124, 0x6d703ef3, 0x7a6d76e9, 0x00000000 };
...
test "single" {
    try htest.assertEqualHash(Ripemd160, "9c1185a5c5e9fc54612808977ee8f548b2258d31", "");
    try htest.assertEqualHash(Ripemd160, "0bdc9d2d256b3ee9daae347be6f4dc835a467ffe", "a");
    try htest.assertEqualHash(Ripemd160, "8eb208f7e05d987a9b044a8e98c6b087f15a0bfc", "abc");
    try htest.assertEqualHash(Ripemd160, "5d0689ef49d2fae572b881b123a85ffa21595f36", "message digest");
    try htest.assertEqualHash(Ripemd160, "f71c27109c692c1b56bbdceb5b9d2865b3708dbc", "abcdefghijklmnopqrstuvwxyz");
    try htest.assertEqualHash(Ripemd160, "12a053384a9c0c88e405a06c27dcf49ada62eb2b", "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
    try htest.assertEqualHash(Ripemd160, "b0e20b6e3116640286ed3a87a5713079b21f5189", "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
}
